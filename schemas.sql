...
CREATE TABLE `TimeTable`( `class_no` INT(2) UNSIGNED NOT NULL, `section` VARCHAR(3) NOT NULL, `day` CHAR(3) NOT NULL, `FROM` TIME NOT NULL, `TO` TIME NOT NULL,  `ID` INT UNSIGNED , `subject` VARCHAR(30) , PRIMARY KEY(`class_no`, `section`, `day`, `FROM`), FOREIGN KEY(`ID`) REFERENCES `teacher`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE);
...
Create Table `Clas`( `class_no` INT(2) UNSIGNED NOT NULL, `section` CHAR(1) NOT NULL, `subject` VARCHAR(30) NOT NULL, `ID` INT UNSIGNED , `students` INT UNSIGNED NOT NULL , `classteacher` CHAR(1) DEFAULT 'N', PRIMARY KEY(`class_no`,`section`, `subject`), FOREIGN KEY(`ID`) REFERENCES `teacher`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE);
...
insert into teacher(NAME, SUBS,  CLASSES, CONTACT, EMAILID) values('MR. Khander', 'PHY, MATH', '3, 4', '7878324242', 'aapte@gmail.com');
insert into teacher(NAME, SUBS,  CLASSES, CONTACT, EMAILID) values('MR. bean', 'ENGLISH, Psychology', '5, 4', '7878324242', 'RAMESH@gmail.com');
insert into teacher(NAME, SUBS,  CLASSES, CONTACT, EMAILID) values('MR. ZUKERBERG', 'FACEBOOK, WHATSAPP', '9, 10', '7878324242', 'ZUKE@gmail.com');
insert into teacher(NAME, SUBS,  CLASSES, CONTACT, EMAILID) values('MR. martin', 'science, MATH', '3, 4', '7878324242', 'aapte@gmail.com');
insert into teacher(NAME, SUBS,  CLASSES, CONTACT, EMAILID) values('MR. Kher', 'HINDI, MATH', '3, 4', '7878324242', 'aapte@gmail.com');

insert into clas values(1,'A', 'PHY', 1, 48, 'N');
insert into clas values(1,'A', 'Psychology', 2, 48, 'N');
insert into clas values(1,'A', 'FACEBOOK', 3, 48, 'Y');
insert into clas values(1,'A', 'WHATSAPP', 3, 48, 'Y');
insert into clas values(1,'A', 'MATH', 4, 48, 'N');
insert into clas values(1,'A', 'science', 4, 48, 'N');
insert into clas values(1,'A', 'HINDI', 5, 48, 'N');
